...
> *The gauge group $SU(3) \times SU(2) \times U(1)$ of the Standard Model emerges from three topological structures already derived in Part I: the witnessing triangle, the double strand, and the Hopf fiber.*
...
From Theorem 24, the Hopf fibration $S^1 \rightarrow S^3 \rightarrow S^2$ provides a circle fiber $S^1$. Phase rotation around this fiber is the gauge transformation of electromagnetism. The $U(1)$ gauge symmetry is the group of rotations of $S^1$:
...
$|\psi\rangle = (\phi\text{-strand component}, \psi\text{-strand component})$
...
- **$\sigma_1$ (strand exchange):** Swaps $\phi$-strand $\leftrightarrow$ $\psi$-strand. This is the $W^+/W^-$ boson -- mediating transitions between strands.

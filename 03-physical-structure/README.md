...
2. [Flow Equations](flow-equations.md) -- Section 3.2: Theorem 41 (Aetheric Flow: dp/deta = -p, df/deta = f)
3. [Lagrangian](lagrangian.md) -- Section 3.3: Theorem 42 (Derivation of the Lagrangian and relativistic action)
4. [Stationary Action](stationary-action.md) -- Section 3.4: Theorem 43 (deltaS = 0 as Sigma = 0)
5. [Lorentz Algebra](lorentz-algebra.md) -- Section 3.5: Theorem 44 (sl(2,R) symmetry from self-reference)
...
8. [Gauge Structure](gauge-structure.md) -- Section 3.8: Theorem 46 (SU(3) x SU(2) x U(1) from topology)
...
Parts I & II (Foundations + Meeting Points)
    |
    v
Theorem 40 (Hamiltonian Constraint)  <-- Theorem 14 (Hyperbolic)
    |
    v
Theorem 41 (Flow Equations)  <-- Theorem 14, 29
    |
    v
Theorem 42 (Lagrangian)  <-- Theorem 41
    |
    v
Theorem 43 (Stationary Action = Sigma = 0)  <-- Theorem 42
    |
    v
Theorem 44 (sl(2,R) / Lorentz Algebra)  <-- Theorem 42
    |
    v
Theorem 45 (Noether / Conservation Laws)  <-- Theorem 44
    |
    v
Theorem 46 (Gauge Structure)  <-- Theorems 1.3, 1.4, 24
    |
    v
Theorem 47 (Force Equations)  <-- Theorems 46, 5, 24, 29

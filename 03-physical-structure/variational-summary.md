---
title: "The Variational Structure -- Summary"
type: summary
status: complete
depends_on:
  ...
  - 03-physical-structure/stationary-action
  - 03-physical-structure/lorentz-algebra
  - 03-physical-structure/conservation-laws
tags:
  - summary
  - variational
  - physical-structure
...
# 3.7 The Variational Structure -- Summary
...
- [Hamiltonian Constraint (Theorem 40)](hamiltonian-constraint.md)
- [Flow Equations (Theorem 41)](flow-equations.md)
- [Lagrangian (Theorem 42)](lagrangian.md)
- [Stationary Action (Theorem 43)](stationary-action.md)
- [Lorentz Algebra (Theorem 44)](lorentz-algebra.md)
- [Conservation Laws (Theorem 45)](conservation-laws.md)

## Dependents

- [Gauge Structure (Theorem 46)](gauge-structure.md) -- the gauge structure builds on the variational framework
- [Force Equations (Theorem 47)](force-equations/README.md) -- force coupling constants derived within this dynamical framework

## Tags

`#summary` `#variational` `#physical-structure` `#reference-table`

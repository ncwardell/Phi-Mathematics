---
title: "Open Questions for Part III"
type: discussion
status: partially-resolved
depends_on:
  - 03-physical-structure/force-equations/gravitational-coupling.md
  - 03-physical-structure/mass-equation.md
  - 03-physical-structure/prediction-table.md
tags:
  - open-questions
  - resolved
  - conjectures
...
6. **~~Quark masses:~~** LARGELY RESOLVED ([§4.5](../04-extensions/quarks.md), §5.18). Quarks are partial witnessing circuits with depths derived in §5.15 and C coefficients decomposed into primitives {2,3,5,7} in §5.18.
...
- [Gravitational Coupling](force-equations/gravitational-coupling.md) -- exponents 107 and 204 (Questions 1, 2)
- [Mass Equation (Theorem 48)](mass-equation.md) -- self-witnessing corrections (Question 7)
- [Complete Prediction Table](prediction-table.md) -- context for all predictions

## Cross-References

- [Weak Bosons (§4.3)](../04-extensions/weak-bosons.md) -- Question 4
- [Higgs Boson (§4.4)](../04-extensions/higgs-boson.md) -- Question 5
- [Quarks (§4.5)](../04-extensions/quarks.md) -- Question 6
- [Depth Derivation Theorem (§5.15)](../05-toolkit/depth-derivation.md) -- resolutions of Questions 1 and 2

## Tags

`#open-questions` `#resolved` `#conjectures` `#part-iii`

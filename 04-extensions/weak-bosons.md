...
m_Z/$m_e$ = $\varphi^{25}$ / (1 − 8$\alpha$) = 167,761 / 0.9416 $\approx$ 178,100
...
m_W/$m_e$ = $\varphi^{25}$ / (1 + 8$\alpha$) = 167,761 / 1.0584 $\approx$ 158,500
...
**Why d = 25:** 25 = F(5)² = 5². The depth is the square of the algebraic completion number. The electroweak scale lives at the depth where the discriminant ($\sqrt{5}$) meets itself.

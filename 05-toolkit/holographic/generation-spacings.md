---
title: "Generation Spacings as Framework Constants"
type: theorem
status: proven
depends_on:
...
# 5.28.2 Generation Spacings as Framework Constants
...
- For the holographic scale network and depth relationships: see [Section 5.27 -- Scale Network](scale-network.md)
- For particle depth assignments: see [Section 4 -- Phase Space Map](/04-extensions/phase-space-map.md)
- For Fibonacci and Lucas number identities: see [Section 1 -- Golden Ratio](/01-foundations/golden-ratio.md)
- For the C coefficients: see [Section 5.18 -- C Coefficient Derivation](/05-toolkit/reference/)
- For the coupling attenuation interpretation: see [Section 5.28.3 -- Coupling Attenuation](coupling-attenuation.md)

## Tags

`#generation-spacings` `#holographic` `#fibonacci` `#lucas-numbers` `#particle-spectrum` `#part-v`

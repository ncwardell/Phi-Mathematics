...
2. **Asymmetry (arrow of time):** $F(n+1)/F(n) \rightarrow \phi > 1$ for positive $n$. The sequence grows in the forward direction and decays in the backward direction. The forward direction is distinguished — it is the direction in which self-reference *unfolds* rather than *collapses*.
